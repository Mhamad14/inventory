...
class Auth extends BaseController
{
    ...
    public function login()
    {
        ...
        // validate form input
        $this->validation->setRule('identity', str_replace(':', '', lang('Mobile')), 'required');
        ...
        if ($this->request->getPost() && $this->validation->withRequest($this->request)->run()) {
            ...
            if ($this->ionAuth->login($this->request->getVar('identity'), $this->request->getVar('password'), $remember)) {
				...
				if ($this->ionAuth->isTeamMember()) {
                    ...
                    $response['csrf_token'] =  csrf_token();
                    $response['csrf_hash'] = csrf_hash();
                    $response['admin'] = $this->ionAuth->isTeamMember();
    ...
    public function forgot_password()
    {
        ...
        $app_name = (isset($settings['title']) && $settings['title'] != "") ? $settings['title'] : "UpBiz";
        $this->data['meta_keywords'] = "subscriptions app, digital subscription, daily subscription, software, app, module";
        $this->data['meta_description'] = "$app_name an digital solution for your subscription based daily problems"; 
