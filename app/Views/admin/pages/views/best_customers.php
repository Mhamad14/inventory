        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <table class="table table-hover table-borderd" data-show-export="true" data-export-types="['txt','excel','csv','json']" data-export-options='{"fileName": "Best Customers","ignoreColumn": ["action"]}' data-auto-refresh="true" data-show-columns="true" data-show-toggle="true" data-show-refresh="true" data-toggle="table" data-search-highlight="true" data-page-list="[5, 10, 25, 50, 100, 200, All]" data-url="<?= base_url('admin/best_customers/best_customers_table'); ?>" data-side-pagination="server" data-pagination="true" data-search="true" data-query-params="best_customers_query" id="best_customers_table">
                        <thead>
                            <tr>
                                <th data-field="customer_id" data-sortable="true" data-visible="true"><?= labels('customer_id', 'Customer ID') ?></th>
                                <th data-field="first_name" data-sortable="true" data-visible="true"><?= labels('name', 'Name') ?></th>
