        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="btn-group mr-2 no-shadow">
                    <a class="btn btn-primary text-white" id="" href="<?= base_url('admin/employees/new'); 
                    ?>" data-toggle="tooltip" data-bs-placement="bottom" title="  <?= labels('add_employee', 'Add employee') ?> "><i class="fas fa-plus"></i> </a>
                </div>
                <div class="btn-group mr-2 no-shadow">
                                ...
                                <table class="table table-hover table-borderd" data-auto-refresh="true"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="address" data-sortable="true" data-visible="true"><?= labels('address', 'Address') ?></th>
                                            <th data-field="mobile" data-sortable="true" data-visible="true"><?= labels('mobile', 'Contact Number') ?></th>
                                            <th data-field="salary" data-sortable="true" data-visible="true"><?= labels('salary', 'Salary') ?></th>
