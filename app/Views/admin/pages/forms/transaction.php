            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <form class="create_order_payment" method="post" action='<?= base_url('admin/transactions/save_payment') ?>' id="create_order_payment">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-group btn-sm rounded-circle" data-toggle="tooltip" data-bs-placement="right" title="select 'Debit' for deducting amount from customer's balance (wallet) and select 'Credit' for adding">
                                        <i class="fas fa-info fs-6 text-info" ></i>
                                    </button>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-hover" data-show-export="true" data-export-types="['txt','excel','csv']" data-export-options='{"fileName": "customers-wallet-list","ignoreColumn": ["action"]}' id="customers_table" data-auto-refresh="true" data-show-columns="true" data-show-toggle="true" data-show-refresh="true" data-toggle="table" data-search-highlight="true" data-server-sort="false" data-page-list="[5, 10, 25, 50, 100, 200, All]" data-url="<?= base_url('admin/transactions/customers_table'); ?>" data-side-pagination="server" data-pagination="true" data-search="true" data-server-sort="false">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="balance" data-sortable="true" data-visible="true"><?= labels('wallet_balance', 'wallet balance') . " (" . currency_location('') . ")" ?></th>
                            ...
                            <div class="col-md">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="transaction_type"><?= labels('filter_transaction', 'Filter Transaction') ?></label>
                                                <select name="transaction_type" id="transaction_type" class="form-control selectric">
                                                    <option value="">-<?= labels('select', 'Select') ?>-</option>
                                                    <option value="0"><?= labels('wallet', 'Wallet') ?></option>
                                        ...
                                        <table class="table table-bordered table-hover" data-show-export="true" data-export-types="['txt','excel','csv']" data-export-options='{"fileName": "customers-wallet-transaction-list","ignoreColumn": ["action"]}' id="transactions_table" data-auto-refresh="true" data-show-columns="true" data-show-toggle="true" data-show-refresh="true" data-toggle="table" data-search-highlight="true" data-server-sort="true" data-page-list="[5, 10, 25, 50, 100, 200, All]" data-url="<?= base_url('admin/transactions/transactions_table'); ?>" data-side-pagination="server" data-pagination="true" data-search="true">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="first_name" data-sortable="true"><?= labels('first_name', 'First Name') ?></th>
                                                    <th data-field="last_name" data-sortable="true"><?= labels('last_name', 'Last Name') ?></th>
