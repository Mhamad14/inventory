    ...
    <template x-if="selected">
        <form id="add_variant_form" @submit.prevent="submitForm" class="mt-4">
            ...
            <div class="form-group mb-2">
                ...
                <input type="number" x-model="form.quantity" id="add_quantity" class="form-control" value="1" placeholder="Ex: 1">
            </div>
            <div class="form-group mb-2">
                <label>Cost Price</label>
                <input type="number" id="add_cost_price" x-model="form.cost_price" class="form-control" placeholder="Ex: 0.00">
            </div>
            <div class="form-group mb-2">
                <label for="add_sell_price">Sell Price</label>
                <input type="number" x-model="form.sell_price" min="0" id="add_sell_price" placeholder="Ex: 0.00" class="form-control">
            </div>
            <div class="form-group mb-2">
                <label>Expire Date</label>
                <input type="text" x-model="form.expire_date" x-ref="expireDateInput" id="add_expire_date" class="form-control">
            </div>
            <div class="form-group mb-2">
                <label>Discount</label>
                <input type="number" id="add_discount" x-model="form.discount" class="form-control" min="0" step="0.01" placeholder="Ex: 0.00">
            </div>
            <div class="form-group mb-2">
                <label for="add_status"><?= labels('status', 'Status') ?></label><span class="asterisk text-danger"> *</span>
                <div class="d-flex">
                    <select class="form-control mr-2" id="add_status" x-model="form.status">
            ...
            <!-- Total sell_total profit -->
            <div class="row mb-2 mt-3">
                <div class="col-sm-12 col-md-6 col-lg-4 text-center">
                    <h6 class="h6 text-black">Cost Total</h6>
                    <h6 class="text-info" x-text="form.cost_total"></h6>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 text-center">
                    <h6 class="h6 text-black">Sell Total</h6>
                    <h6 x-text="form.sell_total"></h6>
                </div>
                <div  class="col-sm-12 col-md-12 col-lg-4 text-center">
                    <h6 class="h6 text-black">Estimated Profit</h6>
                    <h6 class="text-success" x-text="form.profit"></h6>
                </div>
