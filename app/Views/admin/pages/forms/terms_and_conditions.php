        ...
        <div class="section-body">
            <div class="row mt-sm-4">
                <div class='col-md-12'>
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= base_url('admin/settings/save_settings') ?>" id="terms_and_conditions_setting_form" accept-charset="utf-8" method="POST">
                                <h2 class="section-title"><?= labels('terms_and_conditions', 'Terms and Conditions') ?></h2>
                                <div class="row mb-3">
                                    <div class="col-md">
                                        <textarea class="texteditor" rows=30 id="terms_and_conditions" name="terms_and_conditions"><?= !empty($terms_and_conditions) && !empty($terms_and_conditions['terms_and_conditions']) ? $terms_and_conditions['terms_and_conditions'] : " T&C" ?></textarea>
