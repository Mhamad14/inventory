            ...
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="btn-group mr-2 no-shadow">
                        <a class="btn btn-primary text-white" href="<?= base_url('delivery_boy/orders'); ?>" class="btn" data-toggle="tooltip" data-bs-placement="bottom" title=" <?= labels('orders', 'Orders') ?> "><i class="fas fa-list"></i> </a>
                    </div>
                </div>
            </div>
            <?php
                            ...
                            <div class='col-md-12'>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            <section class="p-2">
                                                <form action="<?= base_url('delivery_boy/orders/save_order') ?>" id="place_order_form" accept-charset="utf-8" method="POST">
                            ...
                            <div class='col-md-12'>
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="card">
                                            <section class="p-2">
                                                <form action="<?= base_url('delivery_boy/orders/save_order') ?>" id="place_service_order_form" accept-charset="utf-8" method="POST">
                                                    <div class="mt-2 d-flex justify-content-center">
                                                        <?= labels('already_registered', 'Already Registered') ?>?
                                                        <input type="button" class="btn btn-xs btn-secondary mx-5" id="clear_user_search" value="Clear">
                                                    </div>
                                                    <!-- select user -->
                                                    <div class="mt-2 text-center">
                                                        <select class="select_user form-control" id="service_wallet">
                                                        ...
                                                        <div class=" mb-2 mt-3">
                                                            <div class="">
                                                                ...
                                                                <div class="invoice-detail-item">
                                                                    ...
                                                                    <hr>
                                                                    <label class="payment_status_label_service" for="payment_status">Payment Status</label><span class="asterisk text-danger payment_status_label_service"> *</span>
        ...
        <div class="modal-dialog modal-m">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action='<?= base_url('delivery_boy/orders/register') ?>' id="register_customer">
                        <div class="form-group">
